...
Route::middleware(['auth'])->group(function(){
    ...
    Route::middleware(['userAkses:mahasiswa'])->group(function () {
        ...
        Route::get('/getKotaByProvinsi/{kode_prov}', [MahasiswaController::class, 'getKotaByProvinsi']);
        ...
        Route::get('/mahasiswa/data-akademik', [MahasiswaController::class, 'rekap'])->name('mahasiswa.rekap');
    });
    ...
    Route::middleware(['userAkses:dosen'])->group(function(){
        ...
        Route::patch('/dosen/sksMahasiswa/{nim}', [DosenController::class, 'editIRS'])->name('dosen.editIRS');
        Route::patch('/dosen/sksKHSMahasiswa/{nim}', [DosenController::class, 'editKHS'])->name('dosen.editKHS');
        ...
        Route::get('/dosen/daftar-mahasiswa', [DosenController::class, 'daftarMahasiswa'])->name('dosen.daftarmahasiswa');
        Route::get('/dosen/perwalian/{nim}', [DosenController::class, 'perwalian'])->name('dosen.perwalian');
