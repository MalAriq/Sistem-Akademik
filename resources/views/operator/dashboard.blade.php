...
<div class="p-1 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-8">
    <div class="flex items-center justify-center h-20 mb-4 rounded bg-gray-50 dark:bg-gray-800">
       <p class="text-3xl font-bold text-gray-900 dark:text-white uppercase">Dashboard Operator</p>
      ...
      <div class="grid grid-cols-3 gap-4 mb-4">
         ...
         <img class="mx-auto w-32 h-32 rounded-full border border-gray-800" src="{{ asset('fotoProfil/'.$operator->foto) }}" alt="Foto Pengguna">
