...
<div class="p-1 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-8">
        <div class="flex items-center justify-center h-20 mb-4 rounded bg-gray-50 dark:bg-gray-800">
            <p class="text-3xl font-bold text-gray-900 dark:text-white uppercase">Update Data Mahasiswa</p>
        </div>
        <form method="POST" action="{{ route('operator.update', $mahasiswa->NIM) }}" enctype="multipart/form-data" class="p-3">
            @csrf
            @method('PUT')
            ...
            <div class="mt-3">
                ...
                <input type="text" name="nim" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ $mahasiswa->NIM }}" required >
            </div>
            <div class="mt-3">
            ...
            <div class="mt-3">
                ...
                <input type="text" name="jalur_masuk" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ $mahasiswa->jalur_masuk }}" required >
            </div>
            <div class="grid md:grid-cols-2 md:gap-6 mt-3">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="angkatan" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ $mahasiswa->angkatan }}" required >
                </div>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6 mt-3">
                <div class="relative z-0 w-full mb-6 group">
                    <label class="text-medium text-sm text-gray-500 dark:text-gray-400">Provinsi</label>
                    <select name="provinsi" id="provinsi" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
