...
class DepartemenController extends Controller
{
    public function index()
    {
        ...
        ->pluck('Mahasiswa.id_mhs')
        ->unique()
        ->toArray();

        $jumlahMahasiswaIRS = count($mahasiswaIRS);
        ...
        $jumlahMahasiswaKHS = count($mahasiswaKHS);
        ...
        $jumlahMahasiswaPKL = count($mahasiswaPKL);
        ...
        $jumlahMahasiswaSkripsi = count($mahasiswaSkripsi);
    ...
    public function cetakPKL()
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('departemen.cetakrekappkl', ['pkl' => $pkl]);
    ...
    public function cetakSkripsi()
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('departemen.cetakrekapskripsi', ['skripsi' => $skripsi]);
