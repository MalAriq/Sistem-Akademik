...
<div class="p-1 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-8">
        <div class="flex items-center justify-center h-20 mb-4 rounded bg-gray-50 dark:bg-gray-800">
            <p class="uppercase text-3xl font-bold text-gray-900 dark:text-white">Entry Data PKL</p>
        </div>
                    ...
                    <div class="flex items-center justify-center">
                      ...
                      <div class="flex items-center justify-center w-full mt-2">
                        <div>
                            ...
                            <select name="nilai_pkl" id="nilai_pkl" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                              <option value="" selected disabled>-----Nilai PKL-----</option>
